                        ...
                        <div className="row">
                            <div className="col">
                                <p className="h3 fw-bold">Contact Manager
                                    <Link to={'/contacts/AddContact'} className="btn btn-primary ms-2">
                                    <i className="fa fa-plus-circle me-2"/>
                                    New</Link>
                                </p>
                                    <p className="fst-italic">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Mollitia voluptatem voluptate, culpa aspernatur similique perspiciatis asperiores!
                                </p>
                            </div>
                        </div>
                        <div className="row">
                            ...
                            <div className="card">
                                <div className="card-body">
                                    ...
                                    <div className="col-md-1 d-flex flex-column align-items-center">
                                        <Link to={'/contacts/ViewContact/:contactId'} className="btn btn-warning my-1">
                                            <i className="fa fa-eye"/>
                                        </Link>
                                        <Link to={'/contacts/EditContact/:contactId'} className="btn btn-primary my-1">
